...
- Log to `~/.local/share/rustle/rustle.log` using `tracing` + `tracing-subscriber`
...
- [ ] Optional: auto-move Rustle notes window to a specific workspace when a meeting starts (configurable)
